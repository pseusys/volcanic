...
class Liquid(Textured):
    def __init__(self, shader: Shader, tex_file: str, radius: int, height: int, center_shift=0, speed=4., distortion=6., transparency=1., glowing=False, shininess=1.):
        ...
        uniforms = dict(resolution=resolution, amplitude=.01, center_shift=center_shift, speed=speed, distortion=distortion, transparency=transparency, glowing=glowing)
