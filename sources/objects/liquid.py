...
class Liquid(Textured):
    def __init__(self, shader: Shader, tex_file: str, radius: int, height: int, amplitude=.01, center_shift=0, speed=4., distortion=6., transparency=1., shininess=.1, glowing=False):
